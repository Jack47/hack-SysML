    ...
    def forward(self, hidden_states):
        ...
        if self.training and self.alpha > 0.0:
            ...
            if self.seq_aux:
                ...
                ).div_(seq_len * aux_topk / self.n_routed_experts)  # ce: Tensor[bsz, num_experts]
            ...
            aux_loss, device_loss, comm_loss = None, None, None
        return topk_idx, topk_weight, (aux_loss, device_loss, comm_loss)
